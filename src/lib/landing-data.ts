...
export const landingAccounting: LandingPageData = {
  ...
  benefits: [
    ...
    { title: "Big-4 heritage team", desc: "Former Big-4 and MoF auditors handling your books. Not junior staff on autopilot." },
...
export const landingTaxConsultant: LandingPageData = {
  ...
  italic: "Vietnam for foreign companies",
  description: "Vietnam-based tax consulting for foreign-owned companies: CIT, VAT, FCT, transfer pricing, treaty relief, and GDT audit defence. Big-4 heritage, 14+ years in practice.",
  keywords: ["tax consultant Vietnam", "Vietnam tax advisor", "Vietnam tax consulting", "GDT audit defence Vietnam", "Vietnam tax treaty"],
  heroSubtitle: "GDT-registered. Big-4 alumni. Audit defence, planning, and compliance.",
  intro: "We provide end-to-end tax consulting for foreign-owned companies in Vietnam — from CIT and VAT filing through transfer pricing, FCT, treaty applications, and GDT audit defence. Our team includes former MoF auditors and Big-4 alumni who have represented clients in hundreds of tax audits.",
  benefits: [
    { title: "GDT audit defence", desc: "We represent clients in CIT, VAT, FCT, and TP audits. Former MoF auditors with experience in GDT procedure." },
  ...
  faqs: [
    ...
    { question: "Can a tax consultant represent us in a GDT audit?", answer: "Yes. We are registered tax agents with the GDT and represent clients in CIT, VAT, FCT, and TP audits. Our team includes former MoF auditors with deep experience in GDT procedure." },
...
export const landingTaxAdvisor: LandingPageData = {
  ...
  intro: "For tax positions that matter — cross-border structuring, treaty planning, APA negotiations, BEPS Pillar 2, and high-stakes disputes — you need a tax advisor, not just a tax preparer. Our senior advisors have led Vietnam tax practices at Big-4 firms and now work directly with founders and CFOs of foreign-owned companies.",
  benefits: [
    { title: "Big-4 heritage at boutique cost", desc: "Senior advisors who led Vietnam tax practices at Big-4 firms, now engaged directly without the Big-4 overhead." },
...
export const landingBookkeeping: LandingPageData = {
  ...
  intro: "Outsource your Vietnam bookkeeping to a Big-4 heritage team. We handle transaction processing, bank reconciliation, AP/AR management, and monthly management accounts — all in English, all in the cloud, all delivered on your reporting calendar.",
  benefits: [
...
export const landingCfo: LandingPageData = {
  ...
  intro: "Senior finance leadership for foreign-owned companies in Vietnam — without the cost of a full-time CFO. Our virtual CFOs bring Big-4 and corporate CFO experience to your business on a 1–3 day per month basis: forecasting, board reporting, cash management, fundraising readiness, and M&A advisory.",
  benefits: [
    { title: "Senior CFO experience", desc: "Former Big-4 partners and corporate CFOs who have run finance functions at FDI companies across Vietnam." },
...
export const landingForeignCompanies: LandingPageData = {
  ...
  benefits: [
    ...
    { title: "Real Vietnamese expertise", desc: "Former MoF auditors, Big-4 alumni, and licensed tax agents. When the GDT opens a file, we have done this before." },
