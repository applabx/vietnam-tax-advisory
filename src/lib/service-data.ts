...
export const servicePages: Record<string, ServicePage> = {
  ...
  // ============================================================================
  // NEW COUNTRIES (Germany, France, Canada)
  // ============================================================================
  germany: {
    slug: "germany",
    name: "Accounting & Tax Services for German Companies in Vietnam",
    category: "countries",
    shortName: "Germany",
    hero: {
      eyebrow: "Country",
      title: "Vietnam accounting for",
      italic: "German companies",
      description:
    ...
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign company setup requires an Investment Registration Certificate and an Enterprise Registration Certificate from the DPI. German parent documents must be apostilled and translated." },
      { title: "VAS accounting", desc: "All entities must maintain books under VAS, with annual financial statements in Vietnamese and an English translation for group reporting." },
      { title: "Statutory audit", desc: "All FDI companies must be audited by a Vietnamese-licensed audit firm. The audit is coordinated with the German parent's Konzernabschluss." },
      { title: "HGB reconciliation", desc: "German parents require a reconciliation from VAS to HGB (Handelsgesetzbuch) for the Konzernabschluss. Differences in revenue recognition, leases, and provisions are reconciled quarterly." },
      { title: "Transfer pricing documentation", desc: "Local File, Master File, and CbCR under Decree 132/2020, aligned with BZSt expectations and German GAAP." },
    ],
    costs: [
      { item: "German company monthly retainer (full compliance)", amount: "from EUR 1,500 / month" },
      { item: "Foreign company setup (IRC + ERC)", amount: "from EUR 8,000" },
      { item: "HGB reconciliation (per period)", amount: "from EUR 2,000" },
      { item: "Transfer pricing Local File (EUR-aligned)", amount: "EUR 5,000 – 12,000" },
      { item: "AStG documentation support", amount: "from EUR 6,000 per year" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Initial scoping with German parent, entity structuring advice, IRC pre-engagement." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, post-licence registrations, tax agent appointment." },
      { phase: "First compliance cycle", duration: "Month 3–6", desc: "First month close, first VAT filing, German parent reporting integration." },
      { phase: "Steady state", duration: "From month 7", desc: "Monthly close within 10 working days, HGB reconciliation, quarterly review." },
    ],
    commonMistakes: [
      "Failing to coordinate the Konzernabschluss timeline with the Vietnam year-end close",
      "Missing AStG documentation requirements for German-controlled foreign entities",
      "Treating German parent overhead allocations as fully deductible without benefit-test",
      "Failing to claim Germany-Vietnam DTA treaty rates on dividends and royalties",
      "Ignoring the German permanent establishment implications for German staff on Vietnam assignment",
    ],
    benefits: [
      { title: "HGB-to-VAS reconciliation", desc: "Quarterly reconciliation package prepared in EUR, aligned with the German parent's Konzernabschluss calendar." },
      { title: "EUR-functional reporting", desc: "EUR-functional ledger for management reporting, with FX gain/loss reconciled to the parent's reporting framework." },
      { title: "DTA treaty relief", desc: "German-Vietnam DTA reduces withholding on dividends to 5% (or 0% for qualifying holdings), on interest to 10%, on royalties to 7.5% (or 10%). We claim the reliefs on your behalf." },
      { title: "AStG documentation", desc: "Support for AStG (Außensteuergesetz) documentation requirements, including the German Stundungskonzept (deferral concept) for passive income." },
      { title: "Big-4 + Mittelstand expertise", desc: "We have supported both DAX-40 multinationals and German Mittelstand companies with their Vietnam entities." },
      { title: "German-speaking team", desc: "German-speaking senior advisors available for board, parent, and BZSt liaison as required." },
    ],
    faqs: usFaqs, // reuse general country FAQs; cover key ones below
  },
  france: {
    slug: "france",
    name: "Accounting & Tax Services for French Companies in Vietnam",
    category: "countries",
    shortName: "France",
    hero: {
      eyebrow: "Country",
      title: "Vietnam accounting for",
      italic: "French companies",
      description:
    ...
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign company setup requires an IRC and ERC from the DPI. French parent documents must be apostilled and translated." },
      { title: "VAS accounting", desc: "All entities must maintain books under VAS, with annual financial statements in Vietnamese and an English (or French) translation for group reporting." },
      { title: "Statutory audit", desc: "All FDI companies must be audited by a Vietnamese-licensed audit firm. The audit is coordinated with the French parent's comptes consolidés." },
      { title: "PCG reconciliation", desc: "French parents require a reconciliation from VAS to PCG (Plan Comptable Général) for the comptes consolidés. Differences in provisions, leases, and depreciation are reconciled quarterly." },
      { title: "Transfer pricing documentation", desc: "Local File, Master File, and CbCR under Decree 132/2020, aligned with DGFIP expectations and OECD BEPS." },
    ],
    costs: [
      { item: "French company monthly retainer (full compliance)", amount: "from EUR 1,500 / month" },
      { item: "Foreign company setup (IRC + ERC)", amount: "from EUR 8,000" },
      { item: "PCG reconciliation (per period)", amount: "from EUR 2,000" },
      { item: "Transfer pricing Local File (EUR-aligned)", amount: "EUR 5,000 – 12,000" },
      { item: "Intégration fiscale support", amount: "from EUR 4,000" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Initial scoping with French parent, entity structuring advice, IRC pre-engagement." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, post-licence registrations, tax agent appointment." },
      { phase: "First compliance cycle", duration: "Month 3–6", desc: "First month close, first VAT filing, French parent reporting integration." },
      { phase: "Steady state", duration: "From month 7", desc: "Monthly close within 10 working days, PCG reconciliation, quarterly review." },
    ],
    commonMistakes: [
      "Failing to coordinate the comptes consolidés timeline with the Vietnam year-end close",
      "Missing documentation for the French participation exemption (régime mère-fille)",
      "Treating French parent overhead allocations as fully deductible without benefit-test",
      "Failing to claim France-Vietnam DTA treaty rates on dividends and royalties",
      "Ignoring the French permanent establishment implications for French staff on Vietnam assignment",
    ],
    benefits: [
      { title: "PCG-to-VAS reconciliation", desc: "Quarterly reconciliation package prepared in EUR, aligned with the French parent's comptes consolidés calendar." },
      { title: "EUR-functional reporting", desc: "EUR-functional ledger for management reporting, with FX gain/loss reconciled to the parent's reporting framework." },
      { title: "DTA treaty relief", desc: "French-Vietnam DTA reduces withholding on dividends to 0% (qualifying parent), on interest to 10%, on royalties to 10%. We claim the reliefs on your behalf." },
      { title: "Régime mère-fille support", desc: "Documentation support for the French participation exemption regime, including substance and holding-period requirements." },
      { title: "Big-4 + ETI expertise", desc: "We have supported both CAC-40 multinationals and French SMEs with their Vietnam entities." },
      { title: "French-speaking team", desc: "French-speaking senior advisors available for board, parent, and DGFIP liaison as required." },
    ],
    faqs: usFaqs,
  },
  canada: {
    slug: "canada",
    name: "Accounting & Tax Services for Canadian Companies in Vietnam",
    category: "countries",
    shortName: "Canada",
    hero: {
      eyebrow: "Country",
      title: "Vietnam accounting for",
      italic: "Canadian companies",
      description:
    ...
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign company setup requires an IRC and ERC from the DPI. Canadian parent documents must be apostilled and translated." },
      { title: "VAS accounting", desc: "All entities must maintain books under VAS, with annual financial statements in Vietnamese and an English translation for group reporting." },
      { title: "Statutory audit", desc: "All FDI companies must be audited by a Vietnamese-licensed audit firm. The audit is coordinated with the Canadian parent's group audit." },
      { title: "IFRS reconciliation", desc: "Canadian parents require a reconciliation from VAS to IFRS (already used by Canadian listed companies) for group consolidation." },
      { title: "Transfer pricing documentation", desc: "Local File, Master File, and CbCR under Decree 132/2020, aligned with CRA expectations and OECD BEPS." },
    ],
    costs: [
      { item: "Canadian company monthly retainer (full compliance)", amount: "from USD 1,500 / month" },
      { item: "Foreign company setup (IRC + ERC)", amount: "from USD 8,000" },
      { item: "IFRS-to-VAS reconciliation (per period)", amount: "from USD 1,500" },
      { item: "Transfer pricing Local File (CAD-aligned)", amount: "USD 5,000 – 12,000" },
      { item: "CRA liaison support", amount: "from USD 4,000" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Initial scoping with Canadian parent, entity structuring advice, IRC pre-engagement." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, post-licence registrations, tax agent appointment." },
      { phase: "First compliance cycle", duration: "Month 3–6", desc: "First month close, first VAT filing, Canadian parent reporting integration." },
      { phase: "Steady state", duration: "From month 7", desc: "Monthly close within 10 working days, IFRS reconciliation, quarterly review." },
    ],
    commonMistakes: [
      "Failing to coordinate the Canadian group audit timeline with the Vietnam year-end close",
      "Missing CRA Form T1134 (Foreign Property) reporting for Canadian-resident directors",
      "Treating Canadian parent overhead allocations as fully deductible without benefit-test",
      "Failing to claim Canada-Vietnam DTA treaty rates on dividends and royalties",
      "Ignoring the Canadian permanent establishment implications for Canadian staff on Vietnam assignment",
    ],
    benefits: [
      { title: "IFRS-to-VAS reconciliation", desc: "Quarterly reconciliation package prepared in CAD, aligned with the Canadian parent's group consolidation calendar." },
      { title: "CAD-functional reporting", desc: "CAD-functional ledger for management reporting, with FX gain/loss reconciled to the parent's reporting framework." },
      { title: "DTA treaty relief", desc: "Canada-Vietnam DTA reduces withholding on dividends to 5% (or 10% for portfolio), on interest to 10%, on royalties to 7.5% (or 10%). We claim the reliefs on your behalf." },
      { title: "T1134 reporting support", desc: "Documentation support for Canadian-resident directors' Form T1134 (Foreign Property) reporting requirements." },
      { title: "TSX + private expertise", desc: "We have supported both TSX-listed multinationals and private Canadian companies with their Vietnam entities." },
      { title: "Canadian-style service", desc: "Conservative, English-first, IFRS-fluent service aligned with Canadian accounting and audit standards." },
    ],
    faqs: usFaqs,
  },
  // ============================================================================
  // NEW INDUSTRIES (Logistics, Trading, Consulting, Recruitment)
  // ============================================================================
  logistics: {
    slug: "logistics",
    name: "Accounting & Tax Services for Logistics Companies in Vietnam",
    category: "industries",
    shortName: "Logistics",
    hero: {
      eyebrow: "Industry",
      title: "Vietnam accounting for",
      italic: "logistics companies",
      description:
        "Specialist accounting, tax, payroll, transfer pricing, and audit support for freight forwarding, 3PL, last-mile delivery, and supply-chain companies in Vietnam.",
    },
    overview:
      "Logistics companies in Vietnam — freight forwarders, third-party logistics (3PL) providers, last-mile delivery, warehousing, and supply-chain operators — face a complex tax and compliance environment. We deliver monthly bookkeeping, VAS-compliant financial statements, transfer pricing documentation aligned with both home-country and Vietnamese rules, and full compliance across CIT, VAT, FCT, and PIT. Our team understands the sector-specific revenue patterns (per-shipment, per-mile, per-pallet), expense categorisation (fuel, vehicle leasing, customs brokerage, sub-contracted transport), and FCT exposure on cross-border freight charges.",
    whoNeeds: [
      "International freight forwarders with Vietnam operations",
      "Third-party logistics (3PL) providers operating in Vietnam",
      "Last-mile delivery and e-commerce fulfilment companies",
      "Warehousing and cold-chain operators",
      "Cross-border trucking, rail, and intermodal logistics",
    ],
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign logistics companies typically set up a 100%-foreign-owned subsidiary (WFOE) with the IRC and ERC." },
      { title: "Trade and customs licences", desc: "Freight forwarding requires trade registration; warehousing and 3PL may require sub-licences from customs and other authorities." },
      { title: "VAT on cross-border services", desc: "Cross-border freight services are subject to FCT (5% VAT + 5% PIT deemed) where the foreign provider has no Vietnamese PE." },
      { title: "Transfer pricing for freight mark-ups", desc: "Arm's-length freight mark-ups between related parties must be documented under Decree 132/2020." },
      { title: "Fuel and vehicle expenses", desc: "Fuel and vehicle expenses are deductible with proper VAT invoices; specific VAT rules apply to certain transportation services (e.g. 8% rate)." },
    ],
    costs: [
      { item: "Logistics company monthly retainer", amount: "from USD 1,500 / month" },
      { item: "Foreign logistics company setup", amount: "from USD 8,000" },
      { item: "Transfer pricing for freight mark-ups", amount: "from USD 6,000" },
      { item: "VAT recovery for fuel and vehicle expenses", amount: "from USD 2,500" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Sector scoping, revenue model review, FCT exposure assessment." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, trade registration, customs broker coordination." },
      { phase: "First compliance cycle", duration: "Month 3–6", desc: "First month close, VAT filing, FCT declaration." },
      { phase: "Steady state", duration: "From month 7", desc: "Monthly close, TP documentation, audit support." },
    ],
    commonMistakes: [
      "Treating related-party freight charges as non-arm's-length without TP documentation",
      "Missing FCT obligations on cross-border freight where the foreign provider has no PE",
      "Failing to claim VAT recovery on fuel and vehicle expenses with valid invoices",
      "Ignoring the customs valuation rules for inter-company freight",
    ...
    benefits: [
      ...
      { title: "Cross-border expertise", desc: "We coordinate with the home-country team to ensure consistent treatment and treaty relief." },
    ],
    faqs: usFaqs,
  },
  trading: {
    slug: "trading",
    name: "Accounting & Tax Services for Trading Companies in Vietnam",
    category: "industries",
    shortName: "Trading",
    hero: {
      eyebrow: "Industry",
      title: "Vietnam accounting for",
      italic: "trading companies",
      description:
        "Specialist accounting, tax, payroll, transfer pricing, and audit support for import-export, distribution, and trading companies in Vietnam.",
    },
    overview:
      "Trading companies in Vietnam — import-export distributors, consumer-goods importers, commodities traders, and trading arms of regional groups — face specific tax and compliance issues around customs, VAT on imports, FCT on related-party purchases, and transfer pricing for distribution margins. We deliver monthly bookkeeping, VAS-compliant financial statements, transfer pricing documentation for limited-risk distributors (LRDs), and full compliance across CIT, VAT, FCT, and PIT.",
    whoNeeds: [
      "Import-export trading companies with Vietnam operations",
      "Consumer-goods importers and distributors",
      "Commodities and raw-materials traders",
      "Regional trading arms of multinational groups",
      "E-commerce trading companies with cross-border flows",
    ],
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign trading companies typically set up a WFOE with the IRC and ERC." },
      { title: "Trade registration", desc: "Import-export activity requires trade registration with the DPI and customs broker appointment." },
      { title: "Customs duty and VAT on imports", desc: "Imported goods are subject to customs duty and VAT (paid at customs). VAT can be claimed as input credit by the importer." },
      { title: "FCT on related-party purchases", desc: "Purchases from related foreign suppliers may be subject to FCT (5% VAT + 5% PIT) or treaty-rate withholding." },
      { title: "Transfer pricing for distribution", desc: "Limited-risk distributor (LRD) mark-ups typically range from 3–7% of revenue; the Local File must support the pricing." },
    ],
    costs: [
      { item: "Trading company monthly retainer", amount: "from USD 1,500 / month" },
      { item: "Foreign trading company setup", amount: "from USD 8,000" },
      { item: "Transfer pricing for LRD mark-ups", amount: "from USD 6,000" },
      { item: "Customs duty optimisation", amount: "from USD 3,000" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Sector scoping, revenue model review, FCT exposure assessment." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, trade registration, customs broker coordination." },
    ...
    commonMistakes: [
      "Treating related-party purchases as arm's-length without TP documentation",
      "Missing FCT obligations on cross-border purchases where the foreign supplier has no PE",
      "Failing to claim input VAT on imports (paid at customs) in the VAT return",
      "Under-pricing or over-pricing distribution mark-ups without TP support",
      "Ignoring the customs valuation rules for inter-company purchases",
    ],
    benefits: [
      { title: "Sector-specific expertise", desc: "We understand trading company economics: limited-risk distribution, import-export margins, customs valuation." },
      { title: "FCT compliance", desc: "Cross-border purchases from related foreign suppliers are subject to FCT; we model the regime and ensure compliance." },
      { title: "TP for LRDs", desc: "Local File and benchmarking studies for limited-risk distributors, aligned with OECD and Vietnamese rules." },
      { title: "Customs optimisation", desc: "We work with customs brokers to optimise duty classification, FTA preferential rates, and import VAT recovery." },
      { title: "Cross-border expertise", desc: "We coordinate with the home-country team to ensure consistent treatment and treaty relief." },
    ],
    faqs: usFaqs,
  },
  consulting: {
    slug: "consulting",
    name: "Accounting & Tax Services for Consulting Firms in Vietnam",
    category: "industries",
    shortName: "Consulting",
    hero: {
      eyebrow: "Industry",
      title: "Vietnam accounting for",
      italic: "consulting firms",
      description:
        "Specialist accounting, tax, payroll, transfer pricing, and audit support for management consulting, IT consulting, and professional services firms in Vietnam.",
    },
    overview:
      "Consulting firms in Vietnam — management consultants, IT consultants, advisory firms, and professional services practices — face specific tax and compliance issues around inter-company recharge (cost-sharing), FCT on cross-border service revenue, professional indemnity insurance, and treatment of partner-level income. We deliver monthly bookkeeping, VAS-compliant financial statements, transfer pricing for management fee recharges, and full compliance across CIT, VAT, FCT, and PIT.",
    whoNeeds: [
      "Management consulting firms with Vietnam operations",
      "IT consulting and system integration firms",
      "Strategy, operations, and HR consulting practices",
      "Big-4 and major consulting networks",
      "Boutique advisory and specialist consulting firms",
    ],
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign consulting firms typically set up a WFOE with the IRC and ERC. Some sectors (legal, audit) require additional sub-licences." },
      { title: "VAT on consulting services", desc: "Consulting services supplied in Vietnam are subject to 10% VAT; cross-border services are subject to FCT where the foreign provider has no PE." },
      { title: "FCT on inter-company recharges", desc: "Management fee recharges from offshore parent are subject to FCT (5% VAT + 5% PIT) or treaty-rate withholding with CoR." },
      { title: "Transfer pricing for cost-sharing", desc: "Inter-company cost-sharing arrangements must be arm's length and supported by TP documentation (cost-benefit analysis)." },
      { title: "Partner-level income", desc: "Partners' profit shares are taxed as employment income (PIT) where the partner is an individual, or as dividends where the partner is a corporate entity." },
    ],
    costs: [
      { item: "Consulting firm monthly retainer", amount: "from USD 1,200 / month" },
      { item: "Foreign consulting firm setup", amount: "from USD 6,000" },
      { item: "Transfer pricing for cost-sharing", amount: "from USD 5,000" },
      { item: "FCT compliance for inter-company recharges", amount: "from USD 3,000" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Sector scoping, revenue model review, FCT exposure assessment." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, professional indemnity insurance coordination." },
      { phase: "First compliance cycle", duration: "Month 3–6", desc: "First month close, VAT filing, FCT declaration." },
      { phase: "Steady state", duration: "From month 7", desc: "Monthly close, TP documentation, audit support." },
    ],
    commonMistakes: [
      "Treating inter-company cost recharges as non-arm's-length without TP documentation",
      "Missing FCT obligations on cross-border service revenue where the foreign provider has no PE",
      "Failing to claim input VAT on professional indemnity insurance and office expenses",
      "Misclassifying partners as employees (or vice versa) for PIT purposes",
      "Ignoring the VAT exemption for certain professional services (e.g. some medical, financial)",
    ],
    benefits: [
      { title: "Sector-specific expertise", desc: "We understand consulting firm economics: utilisation, charge-out rates, partner profit shares." },
      { title: "FCT compliance", desc: "Cross-border service revenue and management fee recharges are subject to FCT; we model the regime and ensure compliance." },
      { title: "TP for cost-sharing", desc: "Local File and cost-benefit analysis for inter-company cost-sharing arrangements." },
      { title: "Partner-level advisory", desc: "We advise on partner-level tax: PIT classification, profit-share mechanics, exit planning." },
      { title: "Cross-border expertise", desc: "We coordinate with the home-country team to ensure consistent treatment and treaty relief." },
    ],
    faqs: usFaqs,
  },
  recruitment: {
    slug: "recruitment",
    name: "Accounting & Tax Services for Recruitment Firms in Vietnam",
    category: "industries",
    shortName: "Recruitment",
    hero: {
      eyebrow: "Industry",
      title: "Vietnam accounting for",
      italic: "recruitment firms",
      description:
        "Specialist accounting, tax, payroll, transfer pricing, and audit support for recruitment, staffing, and HR-services firms in Vietnam.",
    },
    overview:
      "Recruitment and staffing firms in Vietnam — permanent placement, contract staffing, RPO (recruitment process outsourcing), and HR-services firms — face specific tax and compliance issues around commission income, contractor classification (PIT vs CIT on the contractor), FCT on cross-border placements, and treatment of placement guarantees. We deliver monthly bookkeeping, VAS-compliant financial statements, transfer pricing for management fee recharges, and full compliance across CIT, VAT, FCT, and PIT.",
    whoNeeds: [
      "Permanent placement and executive search firms",
      "Contract staffing and temporary placement firms",
      "Recruitment process outsourcing (RPO) firms",
      "HR consulting and HR-services firms",
      "Cross-border placement agencies",
    ],
    legalRequirements: [
      { title: "IRC + ERC licensing", desc: "Foreign recruitment firms typically set up a WFOE with the IRC and ERC. Some sectors require additional sub-licences." },
      { title: "VAT on placement fees", desc: "Placement fees are subject to 10% VAT; cross-border placement services are subject to FCT where the foreign provider has no PE." },
      { title: "FCT on cross-border placements", desc: "Cross-border placement fees paid to foreign recruiters are subject to FCT (5% VAT + 5% PIT) or treaty-rate withholding." },
      { title: "Contractor classification", desc: "Independent contractors may be subject to PIT (where the recruiter withholds) or CIT (where the contractor is a registered entity)." },
      { title: "Placement guarantee accounting", desc: "Placement guarantees (refund if the candidate leaves within X months) require revenue recognition deferral under VAS." },
    ],
    costs: [
      { item: "Recruitment firm monthly retainer", amount: "from USD 1,000 / month" },
      { item: "Foreign recruitment firm setup", amount: "from USD 6,000" },
      { item: "FCT compliance for cross-border placements", amount: "from USD 3,000" },
      { item: "Placement guarantee accounting", amount: "from USD 2,500" },
    ],
    timeline: [
      { phase: "Pre-engagement", duration: "Week 1–2", desc: "Sector scoping, revenue model review, FCT exposure assessment." },
      { phase: "Setup", duration: "Week 3–8", desc: "IRC + ERC issuance, contractor classification review." },
      { phase: "First compliance cycle", duration: "Month 3–6", desc: "First month close, VAT filing, FCT declaration." },
      { phase: "Steady state", duration: "From month 7", desc: "Monthly close, TP documentation, audit support." },
    ],
    commonMistakes: [
      "Missing FCT obligations on cross-border placement fees",
      "Misclassifying contractors as employees (or vice versa) for PIT purposes",
      "Recognising placement guarantee refunds incorrectly under VAS",
      "Treating inter-company cost recharges as non-arm's-length without TP documentation",
      "Failing to claim input VAT on recruitment-related expenses",
    ],
    benefits: [
      { title: "Sector-specific expertise", desc: "We understand recruitment firm economics: placement fees, contractor commissions, guarantee provisions." },
      { title: "FCT compliance", desc: "Cross-border placement fees are subject to FCT; we model the regime and ensure compliance." },
      { title: "Contractor classification", desc: "We advise on contractor classification (PIT vs CIT) and the implications for the recruiter and the contractor." },
      { title: "Placement guarantee accounting", desc: "We set up revenue recognition deferrals and reconciliation for placement guarantees." },
      { title: "Cross-border expertise", desc: "We coordinate with the home-country team to ensure consistent treatment and treaty relief." },
    ],
    faqs: usFaqs,
  },
