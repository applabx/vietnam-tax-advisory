      ...
      {sent ? (
        <div className="text-center py-6">
          ...
          <p className="text-[14px] text-ink-muted leading-[1.7] mb-6">
            Your download link is on its way. While you wait, you can{" "}
            <Link href="/resources/faq" className="text-gold underline">browse the FAQ</Link>.
          </p>
          <a
            href="/downloads/vietnam-tax-compliance-checklist.pdf"
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <p className="text-[11px] text-ink-muted leading-[1.6]">
            By submitting, you agree to our <Link href="/privacy" className="text-gold underline">privacy policy</Link>. We use your details to send the checklist and occasional, relevant updates.
          </p>
        </form>
      )}
    </div>
